...
where demandeur_cv.CIN='$cin' and demandeur_cv.CIN=diplome_demandeur.CIN and universite_demandeur.CIN=demandeur_cv.CIN;";
...
<body>
    <div class="cont">
        ...
        <?php
                  ...
                  $image = imagecreatefromstring($result[0]['photo']); 
                 ob_start(); 
...
<div class="column">
  ...
  echo "<span>".$adress."</span>"; 
   ?>
        ...
        <?php
            $sql = "SELECT code_competence from competence_demandeur where CIN='$cin'";
            $sth=$dbco->prepare($sql);
            $sth->execute();
            $result = $sth->fetchAll(PDO::FETCH_ASSOC);
   ...
   ?>
    ...
    <div >
        <a href="decision.php?choix=1&cin=<?php echo $cin; ?>&codoffre=<?php echo $codoffre; ?>" style="width: 100%">
        <button  type="submit" name="accepter" style="    height: 55px;
        width: 100%;
        color: white;
        font-size: 24px;
        font-weight: bold;
        ...
        <a href="decision.php?choix=0&cin=<?php echo $cin; ?>&codoffre=<?php echo $codoffre; ?>" style="width: 100%">
        <button  type="submit" name="refuser" style="    height: 55px;
        width: 100%;
        color: white;
        font-size: 24px;
        font-weight: bold;
